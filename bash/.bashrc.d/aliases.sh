...
alias opencode-web="docker run -it --rm -p 3000:3000 --add-host=host.docker.internal:host-gateway -v $HOME/.config/opencode:/root/.config/opencode -v $HOME/Documents/projects/lang/opencode:/root/.local/share/opencode -v $HOME/Documents/projects/lang/opencode-output:/root/output ghcr.io/anomalyco/opencode serve --hostname 0.0.0.0 --port 3000"
